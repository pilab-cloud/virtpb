...
var file_pilab_cloud_job_status_proto_rawDesc = []byte{
...
var (
	...
	file_pilab_cloud_job_status_proto_rawDescData = file_pilab_cloud_job_status_proto_rawDesc
)

func file_pilab_cloud_job_status_proto_rawDescGZIP() []byte {
	file_pilab_cloud_job_status_proto_rawDescOnce.Do(func() {
		file_pilab_cloud_job_status_proto_rawDescData = protoimpl.X.CompressGZIP(file_pilab_cloud_job_status_proto_rawDescData)
	})
...
var file_pilab_cloud_job_status_proto_goTypes = []interface{}{
...
func file_pilab_cloud_job_status_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_pilab_cloud_job_status_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	file_pilab_cloud_job_status_proto_msgTypes[0].OneofWrappers = []interface{}{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_pilab_cloud_job_status_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_pilab_cloud_job_status_proto_rawDesc = nil
